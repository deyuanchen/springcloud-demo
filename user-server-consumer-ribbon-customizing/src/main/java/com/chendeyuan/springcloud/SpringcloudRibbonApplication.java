...
import com.chendeyuan.springcloud.ruleconfig.ExcludeFromComponent;
import com.chendeyuan.springcloud.ruleconfig.FooConfiguration;
...
@RibbonClient(name = "user-server-provider", configuration = FooConfiguration.class)
